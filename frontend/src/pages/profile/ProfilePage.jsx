              ...
              <div className="flex flex-col gap-4 mt-14 px-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <span className="text-sm text-slate-500">Joined {new Date(profileUser?.createdAt).toLocaleDateString()}</span>
                  </div>
                </div>
                <div className="flex gap-2">
                  <div className="flex gap-1 items-center">
                    <span className="font-bold text-xs">{profileUser?.following?.length || 0}</span>
                    <span className="text-slate-500 text-xs">Following</span>
                  </div>
                  <div className="flex gap-1 items-center">
                    <span className="font-bold text-xs">{profileUser?.followers?.length || 0}</span>
